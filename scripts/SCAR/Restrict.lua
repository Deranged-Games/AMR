function RestrictOptions(playerid)
  ...
  if (playerRace == Race_Hiigaran) then
    ...
    Player_RestrictResearchOption(playerid, "Carrier_187HealthUpgrade1")
    Player_RestrictResearchOption(playerid, "Carrier_187HealthUpgrade2")
    Player_RestrictResearchOption(playerid, "Carrier_187MAXSPEEDUpgrade1")
    Player_RestrictResearchOption(playerid, "Carrier_187MAXSPEEDUpgrade2")
    Player_RestrictResearchOption(playerid, "Carrier_187BUILDSPEEDUpgrade1")
  end
