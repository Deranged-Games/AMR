MissionSelect = {
	...
	;{
		...
		;{
			...
			size = {700, 36}, 
			name = "txtLblTITLE", 
			Text = {text = "$3490", textStyle = "FEHeading1"},
		},{
			type = "TextLabel", 
			position = {16, -2}, 
			size = {700, 36}, 
			name = "txtLblTITLETUT", 
			Text = {text = "ADVANCED MOD: REVIVED", textStyle = "FEHeading1"},
		},{
			type = "TextLabel", 
			position = {17, 34}, 
			size = {700, 21}, 
			name = "txtLblSUBTITLE", 
			Text = {text = "$3491", textStyle = "FEHeading2"},
		},{
			type = "TextLabel", 
			position = {17, 34}, 
			size = {700, 21}, 
			name = "txtLblSUBTITLETUT", 
			Text = {text = "CAMPAIGN MISSION SELECT", textStyle = "FEHeading2"},
		},{
			type = "Frame", 
			position = {28, 112}, 
			size = {742, 338}, 
			...
			;{
				...
				Text = {textStyle = "FEHeading3", vAlign = "Middle"},
			},{
				type = "TextLabel", 
				position = {5, 18}, 
				size = {300, 10}, 
				name = "txtLblChooseTut", 
				Text = {text = "Choose Mission//", textStyle = "FEHeading4"},
			},{
				type = "TextLabel", 
				position = {5, 18}, 
				size = {300, 10}, 
				name = "txtLblChooseMission", 
				Text = {text = "$3492", textStyle = "FEHeading4"},
			},{
				type = "Frame", 
				outerBorderWidth = 1, 
			...
			;{
				...
				;{
					...
					size = {764, 13}, 
					name = "txtLblHELPTEXT", 
					Text = {textStyle = "FEHelpTipTextStyle"},
				},{
					type = "Line", 
					above = 0, 
					lineWidth = 2, 
					...
					helpTip = "$3468", 
					helpTipTextLabel = "txtLblHELPTEXT", 
					Text = {text = "$2610", textStyle = "FEButtonTextStyle"}, 
					...
					helpTip = "$3494", 
					helpTipTextLabel = "txtLblHELPTEXT", 
					Text = {text = "$3493", textStyle = "FEButtonTextStyle"},
				},{
					type = "TextButton", 
					...
					helpTip = "$3470", 
					helpTipTextLabel = "txtLblHELPTEXT", 
					Text = {text = "$3461", textStyle = "FEButtonTextStyle"},
				},{
					type = "TextButton", 
					buttonStyle = "FEButtonStyle1", 
					position = {126, 23}, 
					...
					helpTip = "$3469", 
					helpTipTextLabel = "txtLblHELPTEXT", 
					Text = {text = "$3459", textStyle = "FEButtonTextStyle"},
				},
			},
		},
	},
