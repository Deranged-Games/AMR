HW2StyleSheet = {
	...
	defaultTableStyle = "FETableStyle", pixelUVCoords = 1,
	StringAttributes = {;
		{name = "FEColorHeading1", string = "66,132,164,255"},
		{name = "FEColorHeading2", string = "255,255,255,255"},
		{name = "FEColorHeading3", string = "255,216,0,255"},
		{name = "FEColorHeading4", string = "255,255,255,255"},
		{name = "FEColorBackground1", string = "0,0,0,170"},
		{name = "FEColorBackground2", string = "0,0,0,127"},
		{name = "FEColorDialog", string = "0,0,26, 255"},
		{name = "FEColorOutline", string = "65,130,165,255"},
		{name = "FEColorPopupOutline", string = "55,150,255,255"},
		{name = "FEColorScrollButtonDefault", string = "56,162,250,255"},
		{name = "FEColorScrollButtonOver", string = "255,255,255,255"},
		{name = "FEColorScrollButtonPressed", string = "56,162,250,255"},
		{name = "FEColorScrollButtonDisabled", string = "151,151,151,255"},
		{name = "FEColorDisabled", string = "151,151,151,255"},
		{name = "IGColorBackground1", string = "0,0,0,150"},
		{name = "IGColorOutline", string = "65,130,165,255"},
		{name = "IGColorProgress1", string = "255,216,0,255"},
		{name = "IGColorProgress2", string = "51,244,0,255"},
		{name = "IGColorButton", string = "0,0,0,0"},
		{name = "IGColorButtonBorder", string = "0,175,255,255"},
		{name = "IGColorButtonOver", string = "48,108,136,255"},
		{name = "IGColorButtonOverBorder", string = "255,255,255,255"},
		{name = "IGColorButtonPressed", string = "48,108,136,255"},
		{name = "IGColorButtonPressedBorder", string = "0,175,255,255"},
		{name = "IGColorButtonFlash", string = "48,108,136,255"},
		{name = "IGColorButtonFlashBorder", string = "0,175,255,255"},
		{name = "IGColorButtonText", string = "0,175,255,255"},
		{name = "IGColorButtonDisabled", string = "0,0,0,0"},
		{name = "IGColorButtonDisabledBorder", string = "48,108,136,255"},
		{name = "IGColorButtonDisabledText", string = "48,108,136,255"},
		{name = "IGColorFacilityDisabled", string = "255,255,255,200"},
	},
	DefaultTextStyle = {
		type = "Text", 
	...
	DefaultScrollBarStyle = {
		...
		UpButton = {
			...
			DisabledGraphic = {
				...
				textureUV = {0, 0, 13, 13}, color = "FEColorScrollButtonDisabled"
			},;{
				type = "Button", 
				size = {13, 13}, 
				position = {0, 0}, 
	...
	FEButtonStyle1 = {
		...
		Text = {textStyle = "FEButtonTextStyle"}, 
		;{
			type = "Button", 
			position = {0, 0}, 
			resizeToParent = 1, 
	...
	FETableStyle = {
		...
		DefaultColTitleCell = {
			...
			;{
				...
				Text = {textStyle = "FETableTitleTextStyle"},
			},
		},
		DefaultCell = {
			type = "TableCell", 
	...
	Taskbar_MenuButtonStyle = {
		...
		outerBorderWidth = 1, borderColor = {0, 0, 0, 0}, 
		overBorderColor = {0, 0, 0, 0}, 
		clickedBorderColor = {0, 0, 0, 0}, 
		pressedBorderColor = {255, 255, 255, 255}, 
		soundOnClicked = "SFX_ButtonClick"
	...
	DiplomacyScreen_PlayerButtonStyle = {
		...
		;{
			...
			position = {20, 0}, 
			size = {135, 27}, 
			Text = {textStyle = "DiplomacyScreen_PlayerButtonTextStyle"}, 
			giveParentMouseInput = 1
		},{
			type = "Frame", 
			position = {155, 5}, 
