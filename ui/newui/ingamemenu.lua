...
BTN_SAVEGAME = {
	...
	name = "m_btnSave", 
	width = 240, Text = {textStyle = "FEButtonTextStyle", text = "$5564"}, 
	helpTip = "$5550", 
...
BTN_LOADGAME = {
	...
	name = "m_btnLoad", 
	buttonStyle = "FEButtonStyle1", 
	width = 240, Text = {textStyle = "FEButtonTextStyle", text = "$5565"}, 
	helpTip = "$5551", 
	helpTipTextLabel = "m_lblHelpText", 
...
BTN_SAVEGAME_CAMPAIGN = {
	...
	width = 240, Text = {textStyle = "FEButtonTextStyle", text = "$5566"}, 
	helpTip = "$5552", 
	helpTipTextLabel = "m_lblHelpText", 
...
BTN_LOADGAME_CAMPAIGN = {
	...
	buttonStyle = "FEButtonStyle1", 
	width = 240, Text = {textStyle = "FEButtonTextStyle", text = "$5567"}, 
	helpTip = "$5553", 
	helpTipTextLabel = "m_lblHelpText", 
...
BTN_LOADGAME_RECORDED = {
	...
	buttonStyle = "FEButtonStyle1", 
	width = 240, Text = {textStyle = "FEButtonTextStyle", text = "$5568"}, 
	helpTip = "$5554", 
	helpTipTextLabel = "m_lblHelpText", 
...
BTN_OPTIONS = {
	type = "TextButton", 
	buttonStyle = "FEButtonStyle1", 
	width = 240, Text = {textStyle = "FEButtonTextStyle", text = "$5569"}, 
	helpTip = "$5555", 
	helpTipTextLabel = "m_lblHelpText", 
...
BTN_EXITTOWINDOWS = {
	type = "TextButton", 
	buttonStyle = "FEButtonStyle1", 
	width = 240, Text = {textStyle = "FEButtonTextStyle", text = "$5570"}, 
	helpTip = "$5556", 
	helpTipTextLabel = "m_lblHelpText", 
...
BTN_EXITTOMAINMENU = {
	...
	buttonStyle = "FEButtonStyle1", 
	width = 240, 
	Text = {textStyle = "FEButtonTextStyle", text = "$5571"}, 
	helpTip = "$5557", 
	helpTipTextLabel = "m_lblHelpText", 
...
BTN_ENDCURRENTGAME = {
	...
	buttonStyle = "FEButtonStyle1", 
	width = 240, 
	Text = {textStyle = "FEButtonTextStyle", text = "$5579"}, 
	helpTip = "$5559", 
	helpTipTextLabel = "m_lblHelpText", 
	onMouseClicked = "FE_ExitToMainMenu();"
}
...
BTN_RETIRE = {
	...
	buttonStyle = "FEButtonStyle1", 
	width = 240, 
	Text = {textStyle = "FEButtonTextStyle", text = "$5572"}, 
	helpTip = "$5558", 
	helpTipTextLabel = "m_lblHelpText", 
	onMouseClicked =  [[FE_Retire("MainUI_UserEvent(eMenu)")]]
}
BTN_RETURNTOGAME = {
	...
	width = 240, Text = {textStyle = "FEButtonTextStyle", text = "$5573"}, 
	helpTip = "$5559", 
	helpTipTextLabel = "m_lblHelpText", 
...
BTN_RESTARTTUTORIAL = {
	...
	buttonStyle = "FEButtonStyle1", 
	width = 240, Text = {textStyle = "FEButtonTextStyle", text = "$5575"}, 
	helpTip = "$5561", 
	helpTipTextLabel = "m_lblHelpText", 
...
BTN_RESTARTMISSION = {
	...
	buttonStyle = "FEButtonStyle1", 
	width = 240, Text = {textStyle = "FEButtonTextStyle", text = "$5576"}, 
	helpTip = "$5562", 
	helpTipTextLabel = "m_lblHelpText", 
	onMouseClicked = "FE_RestartGame(1)"
}
BTN_RESTARTMISSION2 = {
	...
	helpTip = "$5562", 
	helpTipTextLabel = "m_lblHelpText", 
	onMouseClicked = "FE_RestartGame(0)"
}
BTN_RESTART = {
	type = "TextButton", 
	name = "m_btnRestart", 
...
InGameMenu = {
	...
	RootElementSettings = {backgroundColor = "FEColorBackground2"}, 
	pixelUVCoords = 1, 
