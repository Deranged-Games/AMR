function Chatter_Init()
    ...
    setGlobalFrequencyMin(-5)
    setGlobalFrequencyMax(2.0)
end
...
Probabilities = { 
    ...
    { name = "StatusBattleMomentumProb", randomWeight = 60, maxDistance = 40000, expDistance = 1, minWaveLength = 3, expWaveLength = 1, minRepeatProximity = 2000, expRepeatProximity = 1, }, 
    { name = "AmbientProb", randomWeight = 90, maxDistance = 5000, expDistance = 0, minWaveLength = 1, expWaveLength = 1, minRepeatProximity = 0, expRepeatProximity = 0, }, 
}
...
ChatterEvents = { 
    ...
    { id = CE_STS_BATTLEMOMENTUM, name = "StatusBattleMomentum", probability = "StatusBattleMomentumProb", customFnc = { "StatusBattleMomentum", F_N, }, }, 
    ...
    { id = CE_CHT_MISC, name = "ChatterMisc", probability = "AmbientProb", customFnc = { "ChatterMisc", F_SSN, }, }, 
    ...
    { id = CE_CHT_BATTLEMISC, name = "BattleChatMisc", probability = "AmbientProb", customFnc = { "BattleChatMisc", F_SSN, }, }, 
