...
function ChatterMisc(shipnm, parm2, code)
    ...
    elseif shiptype == Fighter or shiptype == Corvette then            
	playSpeechActor("chatter_fighter_misc", NameFighterPilot, 1, Frequency_Command)
    elseif shiptype == Frigate or shiptype == Capital then            
	playSpeechActor("chatter_capital_misc", NameCapPilot, 1, Frequency_Command)
    end
end
...
attackMap.Vgr_CrusaderFrigate = { "STATUS_VCrusaderFrigate_Under_Attack", NameCapPilot, NumCapPilots, }
...
function BattleChatMisc(ssname, parm2, code)
    ...
    if (code == 1 or code == 2) and shipType == Capital then
	playSpeechActor("chatter_capital_misc", NameCapPilot, 1, Frequency_Command)
    ...
    elseif (code == 1 or code == 2) and shipType == Fighter then
