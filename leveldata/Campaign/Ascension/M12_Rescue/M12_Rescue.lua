...
function GrantAIResearch()
	...
	Player_GrantResearchOption(i, "MFmissiles")
	Player_GrantResearchOption(i, "heavyfighterchassis")
	Player_GrantResearchOption(i, "fighterlasers")
	Player_GrantResearchOption(i, "fightersystems")
	Player_GrantResearchOption(i, "strikemissiles")
	Player_GrantResearchOption(i, "CorvetteCommand")
	Player_GrantResearchOption(i, "CorvetteLaser")
	Player_GrantResearchOption(i, "microlanceturret")
	Player_GrantResearchOption(i, "FrigateInfiltrationTech")
	Player_GrantResearchOption(i, "CrusaderFrigateResearch")
	Player_GrantResearchOption(i, "StealthTorpedoResearch")
	Player_GrantResearchOption(i, "railgunsystems")
	Player_GrantResearchOption(i, "rapiermissilesystem")
	Player_GrantResearchOption(i, "DestroyerGuns")
	Player_GrantResearchOption(i, "BattleshipEngines")
	Player_GrantResearchOption(i, "heavydestroyerchassis")
	Player_GrantResearchOption(i, "IonCruiserChassis")
	Player_GrantResearchOption(i, "PlatformHeavyMissiles")
	Player_GrantResearchOption(i, "HyperspaceGateTech")
	Player_GrantResearchOption(i, "RepairAbility")
	Player_GrantResearchOption(i, "MothershipBUILDSPEEDUpgrade1")
	Player_GrantResearchOption(i, "ShipyardBUILDSPEEDUpgrade1")
	Player_GrantResearchOption(i, "CarrierBUILDSPEEDUpgrade1")
	...
	Player_GrantResearchOption(i, "CorvetteSpeedUpgrade1")
	Player_GrantResearchOption(i, "CorvetteSpeedUpgrade2")
	Player_GrantResearchOption(i, "FrigateHealthUpgrade1")
	Player_GrantResearchOption(i, "FrigateHealthUpgrade2")
	Player_GrantResearchOption(i, "FrigateSpeedUpgrade1")
	Player_GrantResearchOption(i, "SpeedUpgrade2")
	Player_GrantResearchOption(i, "FighterspeedUpgrade1")
	Player_GrantResearchOption(i, "FighterspeedUpgrade2")
	Player_GrantResearchOption(i, "ScoutEMPAbility")
	Player_GrantResearchOption(i, "BomberImprovedBombs")
	end
end
