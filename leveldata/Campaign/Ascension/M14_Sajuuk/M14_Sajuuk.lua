...
function Rule_Init()
	...
	Rule_AddInterval("Rule_BuildForCounterOffensive", 720)
	HW2_ReactiveInfo()
	Rule_Remove("Rule_Init")
end

function Rule_BuildForCounterOffensive()
	Player_SetRU(1, 50000)
	Player_SetRU(2, 50000)
	Rule_AddInterval("Rule_BeginCounterOffensive", 300)
	Rule_Remove("Rule_BuildForCounterOffensive")
end

function Rule_BeginCounterOffensive()
	Player_SetRU(1, 5000)
	Player_SetRU(2, 5000)
	CPU_DoString(1, "AttackNow()")
	CPU_DoString(2, "AttackNow()")
	Rule_Remove("Rule_BuildForCounterOffensive")
end
...
function Rule_GrantAIResearch()
   for AINum = 1, 2 do
	...
	Player_GrantResearchOption(AINum, "MothershipBUILDSPEEDUpgrade1")
	Player_GrantResearchOption(AINum, "ShipyardBUILDSPEEDUpgrade1")
	Player_GrantResearchOption(AINum, "CarrierBUILDSPEEDUpgrade1")
	Player_GrantResearchOption(AINum, "SuperCapHealthUpgrade1")
	Player_GrantResearchOption(AINum, "SuperCapHealthUpgrade2")
	Player_GrantResearchOption(AINum, "SuperCapSpeedUpgrade1")
	Player_GrantResearchOption(AINum, "SuperCapSpeedUpgrade2")
	Player_GrantResearchOption(AINum, "CorvetteHealthUpgrade1")
	Player_GrantResearchOption(AINum, "CorvetteHealthUpgrade2")
	Player_GrantResearchOption(AINum, "CorvetteSpeedUpgrade1")
	Player_GrantResearchOption(AINum, "CorvetteSpeedUpgrade2")
	Player_GrantResearchOption(AINum, "FrigateHealthUpgrade1")
	Player_GrantResearchOption(AINum, "FrigateHealthUpgrade2")
	Player_GrantResearchOption(AINum, "FrigateSpeedUpgrade1")
	Player_GrantResearchOption(AINum, "SpeedUpgrade2")
	Player_GrantResearchOption(AINum, "FighterspeedUpgrade1")
	Player_GrantResearchOption(AINum, "FighterspeedUpgrade2")
