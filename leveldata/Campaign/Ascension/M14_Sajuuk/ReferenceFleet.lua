Fleet = {
	...
	{Type = "Hgn_Interceptor", Number = 4},
	{Type = "Hgn_AttackBomber", Number = 1},
	{Type = "Hgn_AssaultCorvette", Number = 3},
	{Type = "Hgn_MarineFrigate", Number = 1},
	{Type = "Hgn_AssaultFrigate", Number = 2},
	{Type = "Hgn_TorpedoFrigate", Number = 2},
