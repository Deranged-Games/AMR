...
function Enable_ResearchOptions()
	...
	Player_UnrestrictBuildOption(0, "Hgn_LRDestroyer")
	Player_UnrestrictBuildOption(0, "Hgn_Cruiser")
	Player_UnrestrictBuildOption(0, "Hgn_LightCruiser")
	Player_UnrestrictBuildOption(0, "Hgn_StrikeCruiser")
...
function AI_BulkResearchGrant(AI_Number)
	...
	Player_GrantResearchOption(AI_Number, "MFmissiles")
	Player_GrantResearchOption(AI_Number, "heavyfighterchassis")
	Player_GrantResearchOption(AI_Number, "fighterlasers")
	Player_GrantResearchOption(AI_Number, "fightersystems")
	Player_GrantResearchOption(AI_Number, "strikemissiles")
	Player_GrantResearchOption(AI_Number, "CorvetteTech")
	Player_GrantResearchOption(AI_Number, "CorvetteCommand")
	Player_GrantResearchOption(AI_Number, "CorvetteLaser")
	Player_GrantResearchOption(AI_Number, "microlanceturret")
	Player_GrantResearchOption(AI_Number, "FrigateTech")
	Player_GrantResearchOption(AI_Number, "FrigateInfiltrationTech")
	Player_GrantResearchOption(AI_Number, "CrusaderFrigateResearch")
	Player_GrantResearchOption(AI_Number, "StealthTorpedoResearch")
	Player_GrantResearchOption(AI_Number, "railgunsystems")
	Player_GrantResearchOption(AI_Number, "rapiermissilesystem")
	Player_GrantResearchOption(AI_Number, "DestroyerGuns")
	Player_GrantResearchOption(AI_Number, "BattleshipEngines")
	Player_GrantResearchOption(AI_Number, "heavydestroyerchassis")
	Player_GrantResearchOption(AI_Number, "IonCruiserChassis")
