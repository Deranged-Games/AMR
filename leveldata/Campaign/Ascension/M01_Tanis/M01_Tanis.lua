...
function Rule_PlayerIsAtChimera()
  ...
  if (g_probesdeployed == 1 and SobGroup_Empty("tempSobGroup") == 1 and Event_IsDone("speechevent_chimerareporting") == 1) then
    ...
    Player_UnrestrictBuildOption(g_playerID, "Hgn_multirolefighter")
  end
end
...
function Rule_CreateMothershipAttackers()
  ...
  SobGroup_SpawnNewShipInSobGroup(3, "Vgr_HeavyBomber", "MothershipAttackers_B10", "MothershipAttackers_Bombers_1", "vol_SpawnMothershipAttackers")
  SobGroup_SpawnNewShipInSobGroup(3, "Vgr_HeavyBomber", "MothershipAttackers_B20", "MothershipAttackers_Bombers_2", "vol_SpawnMothershipAttackers")
  for i = 1, 2 do
...
function Rule_LaunchTheMothership()
   ...
   SobGroup_FillShipsByType("tempSobGroup", "Player_Ships0", "Hgn_MultiroleFighter")
   SobGroup_ParadeSobGroup("tempSobGroup", "Mothership", 0)
   Event_Start("autofocus_mothershiplaunches")
...
function CreateMoreAttackers()
  SobGroup_FillShipsByType("tempSobGroup", "Player_Ships0", "Hgn_MultiroleFighter")
  numberOfmultiroles = SobGroup_Count("tempSobGroup")
  SobGroup_FillShipsByType("tempSobGroup", "Player_Ships0", "Hgn_Interceptor")
  numberOfInterceptors = SobGroup_Count("tempSobGroup") + numberOfmultiroles
  ...
  if (numberOfBombers >= 10) then
    ...
    if (numberOfNewInterceptors > 0) then
      ...
      for i = 1, numberOfNewInterceptors do
        SobGroup_SpawnNewShipInSobGroup(3, "Vgr_MultiroleFighter", "WaveOne_Attackers_2", "WaveOne_Attackers_2", "vol_WaveOne_Gate_2_A")
      end 
    end
