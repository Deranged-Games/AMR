...
function Rule_Init()
	...
	VaygrShipList = {
		{"Vgr_Interceptor", 20, 11}, 
		{"Vgr_MultiroleFighter", 21, 11}, 
		{"Vgr_HeavyFighter", 22, 11}, 
		{"Vgr_StrikeFighter", 23, 11}, 
		{"Vgr_Defender", 24, 11}, 
		{"Vgr_LanceFighter", 25, 11}, 
		{"Vgr_Bomber", 26, 11}, 
		{"Vgr_heavybomber", 27, 11}, 
		{"Vgr_MissileCorvette", 28, 11}, 
		{"Vgr_LaserCorvette", 29, 11},
		{"Vgr_MultiLanceCorvette", 30, 11},
		{"Vgr_AssaultFrigate", 31, 10}, 
		{"Vgr_GunFrigate", 32, 10},
		{"Vgr_HeavyMissileFrigate", 33, 10}, 
		{"Vgr_ArtilleryFrigate", 34, 10},
		{"Vgr_CrusaderFrigate", 35, 10}, 
		{"Vgr_WarFrigate", 36, 10},
		{"Vgr_EMPFrigate", 37, 10}, 
	}
...
function Rule_PlayerCanBuildIonCannonFrigates()
	...
	Event_Start("speechevent_ioncannonsavailable")
      Player_UnrestrictBuildOption(0, "Hgn_PlasmaFrigate")
      Player_UnrestrictBuildOption(0, "Hgn_MissileFrigate")
      Player_UnrestrictBuildOption(0, "Hgn_SiegeCorvette")
      Player_UnrestrictBuildOption(0, "Hgn_StrikeCorvette")
      Player_UnrestrictBuildOption(0, "Hgn_Battleship")
