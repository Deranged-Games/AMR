...
function Rule_GrantAIResearch()
	...
	Player_GrantResearchOption(1, "MFmissiles")
	Player_GrantResearchOption(1, "heavyfighterchassis")
	Player_GrantResearchOption(1, "fighterlasers")
	Player_GrantResearchOption(1, "fightersystems")
	Player_GrantResearchOption(1, "strikemissiles")
	Player_GrantResearchOption(1, "CorvetteCommand")
	Player_GrantResearchOption(1, "CorvetteLaser")
	Player_GrantResearchOption(1, "microlanceturret")
	Player_GrantResearchOption(1, "FrigateInfiltrationTech")
	Player_GrantResearchOption(1, "CrusaderFrigateResearch")
	Player_GrantResearchOption(1, "StealthTorpedoResearch")
	Player_GrantResearchOption(1, "railgunsystems")
	Player_GrantResearchOption(1, "rapiermissilesystem")
	Player_GrantResearchOption(1, "DestroyerGuns")
	Player_GrantResearchOption(1, "BattleshipEngines")
	Player_GrantResearchOption(1, "heavydestroyerchassis")
	Player_GrantResearchOption(1, "IonCruiserChassis")
	...
	Player_GrantResearchOption(1, "CorvetteSpeedUpgrade2")
	...
	Player_GrantResearchOption(1, "SpeedUpgrade2")
	Player_GrantResearchOption(1, "FighterspeedUpgrade1")
	Player_GrantResearchOption(1, "FighterspeedUpgrade2")
	Player_GrantResearchOption(1, "ScoutEMPAbility")
	Player_GrantResearchOption(1, "BomberImprovedBombs")
	Player_GrantResearchOption(3, "CorvetteHealthUpgrade1")
	Player_GrantResearchOption(3, "CorvetteHealthUpgrade2")
	Player_GrantResearchOption(3, "CorvetteSpeedUpgrade1")
	Player_GrantResearchOption(3, "CorvetteSpeedUpgrade2")
	Player_GrantResearchOption(3, "FrigateHealthUpgrade1")
	Player_GrantResearchOption(3, "FrigateHealthUpgrade2")
	Player_GrantResearchOption(3, "FrigateSpeedUpgrade1")
	Player_GrantResearchOption(3, "SpeedUpgrade2")
	Player_GrantResearchOption(3, "FighterspeedUpgrade1")
	Player_GrantResearchOption(3, "FighterspeedUpgrade2")
	Player_GrantResearchOption(3, "ScoutEMPAbility")
	Player_GrantResearchOption(3, "BomberImprovedBombs")
...
function Rule_NISHasFinished()
	Event_Start("intelevent_beginning")
...
function Rule_watchForInitialAttackToDie()
   if (SobGroup_Empty("InitialAttack_Battlecruiser") == 1) and (SobGroup_Empty("InitialAttack_Bombers1") == 1) and (SobGroup_Empty("InitialAttack_HeavyMissileFrigates1") == 1) and 
	(SobGroup_Empty("InitialAttack_LaserCorvettes1") == 1) and (SobGroup_Empty("InitialAttack_LaserCorvettes1") == 1) then
...
Events = {}
Events["intelevent_beginning"] = {{HW2_Wait(1)},{HW2_Letterbox(0),{"Sensors_Toggle(0)", ""}, {"Sound_ExitIntelEvent()", ""},},{HW2_Wait(1)},{{"EventPlaying = 0", ""},},}
