...
function Enable_ResearchOptions()
	...
	Player_UnrestrictBuildOption(0, "Hgn_Assaultcarrier")
...
function Rule_Setup_AI()
	...
	Player_GrantResearchOption(3, "MFmissiles")
	Player_GrantResearchOption(3, "heavyfighterchassis")
	Player_GrantResearchOption(3, "fighterlasers")
	Player_GrantResearchOption(3, "fightersystems")
	Player_GrantResearchOption(3, "strikemissiles")
	...
	Player_GrantResearchOption(3, "microlanceturret")
	Player_GrantResearchOption(3, "FrigateTech")
	Player_GrantResearchOption(3, "FrigateInfiltrationTech")
	Player_GrantResearchOption(3, "CrusaderFrigateResearch")
	Player_GrantResearchOption(3, "StealthTorpedoResearch")
	Player_GrantResearchOption(3, "railgunsystems")
	Player_GrantResearchOption(3, "rapiermissilesystem")
	Player_GrantResearchOption(3, "DestroyerGuns")
	Player_GrantResearchOption(3, "BattleshipEngines")
	Player_GrantResearchOption(3, "heavydestroyerchassis")
	Player_GrantResearchOption(3, "IonCruiserChassis")
