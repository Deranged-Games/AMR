...
function Setup_AI()
	...
	Player_GrantResearchOption(2, "MFmissiles")
	Player_GrantResearchOption(2, "heavyfighterchassis")
	Player_GrantResearchOption(2, "fighterlasers")
	Player_GrantResearchOption(2, "fightersystems")
	Player_GrantResearchOption(2, "strikemissiles")
	Player_GrantResearchOption(2, "CorvetteTech")
	Player_GrantResearchOption(2, "CorvetteCommand")
	Player_GrantResearchOption(2, "CorvetteLaser")
	Player_GrantResearchOption(2, "microlanceturret")
	Player_GrantResearchOption(2, "FrigateTech")
	Player_GrantResearchOption(2, "FrigateInfiltrationTech")
	Player_GrantResearchOption(2, "CrusaderFrigateResearch")
	Player_GrantResearchOption(2, "StealthTorpedoResearch")
	Player_GrantResearchOption(2, "railgunsystems")
	Player_GrantResearchOption(2, "rapiermissilesystem")
	Player_GrantResearchOption(2, "DestroyerGuns")
	Player_GrantResearchOption(2, "BattleshipEngines")
	Player_GrantResearchOption(2, "heavydestroyerchassis")
	Player_GrantResearchOption(2, "IonCruiserChassis")
...
function Rule_Shipyard_RocksUp()
	...
	Player_UnrestrictBuildOption(0, "Hgn_HeavyCruiser")
